                ...
                <div class="row">
                    <div class="col-sm-4 wow fadeInLeft">
                        <div class="team-member">
                            <img src="{{ asset('assets/img/landing/avatar3.jpg')}}" class="img-fluid rounded-circle img-small" alt="">
                    ...
                    <div class="col-sm-4">
                        <div class="team-member wow zoomIn">
                            <img src="{{ asset('assets/img/landing/avatar1.jpg')}}" class="img-fluid rounded-circle" alt="">
                    ...
                    <div class="col-sm-4 wow fadeInRight">
                        <div class="team-member">
                            <img src="{{ asset('assets/img/landing/avatar2.jpg')}}" class="img-fluid rounded-circle img-small" alt="">
                ...
                <div class="row">
                    <div class="col-lg-4 wow zoomIn">
                        <ul class="pricing-plan list-unstyled">
                            ...
                            <li>
                                <a class="btn btn-primary btn-sm" href="#">Signup</a>
                            </li>
                        </ul>
                    </div>
