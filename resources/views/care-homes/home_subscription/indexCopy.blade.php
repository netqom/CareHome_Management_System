                    ...
                    <div class="ibox">
                        <div class="ibox-content product-box">
                            <div class="product-imitation p-0 position-relative">
                                @if($subscription)
                                    <div class="badge badge-warning py-1 ml-2 mt-2 position-absolute" style="font-size: 12px;">
                                        ...
                                        <p class="mb-0">{{ date_format($subscription->created_at, 'm-d-y')}}</p>
                                    </div>
                            ...
                            <div class="product-desc">
                                ...
                                <small class="text-muted">{{ $value->duration == 1 ? 'Monthly' : 'Yearly' }}</small>
                                ...
                                <div class="m-t text-left">
                                    @if($subscription && ($subscription->stripe_status == 'completed' || $subscription->stripe_status == 'active')) 
