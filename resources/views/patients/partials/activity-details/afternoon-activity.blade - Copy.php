@php $activity_form = getShiftLogField(2);
	...
	<tbody>
		...
		<tr class="border-none">
			...
			<td class="border-none d-flex justify-content-between">
				<p>Reporter: <span class="border-bottom border-dark border-3"> {{ $afternoon_time != '' ? ($log->added_by ? $log->added_by->name : '-') : '' }}</span></p>
				<p>Time: <span class="border-bottom border-dark border-3">{{ $afternoon_time }}</span></p>
			</td>
		</tr>
	</tbody>	
</table>
